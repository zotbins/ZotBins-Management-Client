...
const BASE_INFRASTRUCTURE_URL = "http://sensoria.ics.uci.edu:8059/infrastructure/get?";
...
export function getObservations(sensorId, startTime=null, endTime=null){
    ...
    let url = BASE_OBSERVATION_URL + "sensor_id=" + sensorId + "&start_timestamp=" + encodeURIComponent(startTime) + "&end_timestamp=" + encodeURIComponent(endTime);
    let params = {
        headers: {
            "Access-Control-Allow-Origin": "*"
        }
